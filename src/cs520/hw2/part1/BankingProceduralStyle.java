...
public class BankingProceduralStyle {
	...
	private BankingProceduralStyle() {
	...
	private static double investedCD(String bankName, int year, int initialDeposit, double interestRate) {
		...
		System.out.println("Bank" + bankName + " " + year + "-year " + " CD " + dollarSign.format(initialDeposit)
				+ " at " + df.format(interestRate) + " rate " + " is " + " worth " + dollarSign.format(finalValue));
		return finalValue;
